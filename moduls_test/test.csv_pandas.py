...
input_csv_file = input("===> Введите путь и имя csv файла в формате '../path/path/file_name', где:\n"
...
if answer_user.lower() in list_answers_yes:
    ...
    input_excel_file = input("===> Введите путь и имя excel файла в формате '../path/path/file_name', где:\n"
                             "===> .. - корневой каталог\n===> path - директория\\папка\n===> file_name - имя файла (с расширением)\n"
                             "===> Ввод: ")
    if input_excel_file == '':
        print(excel_worker())
